...
const DashboardClient: React.FC<Props> = ({ initialData, selectedTags }) => {
    ...
    // URLパラメータから現在のタブを取得 (デフォルトは 'tourism')
    const currentTab = searchParams.get('tab');
    const isValidTab = (tab: string | null): tab is Tab => {
        return ['tourism', 'history', 'plan'].includes(tab as any);
    };
    const activeTab = isValidTab(currentTab) ? currentTab : 'tourism';
