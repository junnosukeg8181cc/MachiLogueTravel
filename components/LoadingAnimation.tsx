            ...
            <div className="relative w-48 h-48">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-32 h-32 bg-primary/10 dark:bg-primary/20 rounded-full flex items-center justify-center">
                        {/* ★重要: !text-8xl で強制的にサイズを適用 */}
                        <Icon name="public" className="!text-8xl text-primary animate-pulse" />
                    </div>
                </div>
            </div>
            
            <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mt-10">
                AIが旅のデータを生成中...
            </h2>
            <p className="text-slate-500 dark:text-slate-400 mt-3 font-medium">
                最高の情報をお届けするために、少々お待ちください。
            </p>
